...
namespace Romulus
{
    ...
    /// <summary>
    /// Contains functions for converting between hex strings and byte arrays.
    /// </summary>
    public static class Hex
    {
        ...
        /// </summary>
        /// <param name="hex">Bytes to convert to hex</param>
        /// <param name="casing">Casing to use</param>
        /// <returns>A string containing hex data</returns>
        ...
        /// <summary>
        /// Parses a hex string and returns it as a byte array
        /// </summary>
        /// <param name="hex">A string containing only valid hexadecimal data.</param>
        /// <returns>A byte array containing the hex data from the string</returns>
        /// <exception cref="ArgumentException">Thrown if the string is not valid</exception>
        /// <exception cref="ArgumentNullException">Thrown if a null reference is passed as a parameter.</exception>
